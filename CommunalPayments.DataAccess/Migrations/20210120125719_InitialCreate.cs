...
namespace CommunalPayments.DataAccess.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 1, new DateTime(2017, 3, 1), 0, 0.9M, "гр/квт", "При потреблении в мес. до 100квт/час", true, 1 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 2, new DateTime(2017, 3, 1), 100, 1.68M, "гр/квт", "При потреблении в мес. свыше 100квт/час", true, 1 });
