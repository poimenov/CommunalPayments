...
namespace CommunalPayments.DataAccess.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //Rates
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 11, new DateTime(2018, 11, 1), 0, 8.54892M, "гр/м3", "Цена газа для бытовых потребителей", false, 7 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 1, new DateTime(2017, 3, 1), 0, 0.9M, "гр/квт", "При потреблении в мес. до 100квт/час", false, 1 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 2, new DateTime(2021, 1, 1), 0, 1.68M, "гр/квт", "Фиксированная цена вне зависимости от потребления", true, 1 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 3, new DateTime(2019, 1, 1), 0, 39.38M, "гр/м2", "Отопление по норме в отопительный период", false, 3 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 4, new DateTime(2019, 1, 1), 0, 1539.5M, "гр/ГКал", "Отопление по счетчику", false, 3 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 5, new DateTime(2019, 1, 1), 0, 93.22M, "гр/м3", "Горячая вода с полотенцесушителем", true, 4 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 6, new DateTime(2019, 1, 1), 0, 86.32M, "гр/м3", "Горячая вода без полотенцесушителя", false, 4 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 7, new DateTime(2019, 4, 21), 0, 13.14M, "гр/м3", "Услуги водоснабжения для домов с использованием внутридомовых сетей", true, 5 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 8, new DateTime(2019, 4, 21), 0, 12.25M, "гр/м3", "Услуги водоснабжения для домов без использованием внутридомовых сетей", false, 5 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 9, new DateTime(2019, 4, 21), 0, 6.696M, "гр/м3", "Услуги водоотведения для домов с использованием внутридомовых сетей", true, 6 });
            migrationBuilder.InsertData(table: "Rates", columns: new[] { "Id", "DateFrom", "VolumeFrom", "Value", "Measure", "Description", "Enabled", "ServiceId" }, values: new object[] { 10, new DateTime(2019, 4, 21), 0, 6.264M, "гр/м3", "Услуги водоотведения для домов без использованием внутридомовых сетей", false, 6 });
            //PayModes
